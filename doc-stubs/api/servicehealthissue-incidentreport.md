...
-->
``` http
GET /serviceAnnouncement/issues/{serviceHealthIssueId}/incidentReport
```
...
-->
``` http
GET https://graph.microsoft.com/beta/serviceAnnouncement/issues/{serviceHealthIssueId}/incidentReport
```

...
-->
``` http
GET /serviceAnnouncement/healthOverviews/{serviceHealthId}/issues
```
...
-->
``` http
GET https://graph.microsoft.com/beta/serviceAnnouncement/healthOverviews/{serviceHealthId}/issues
```
